...
# Load datasets
train_dataset = ImageFolder(root='building_identify/data/images/test', transform=transform)
test_dataset = ImageFolder(root='building_identify/data/images/train', transform=transform)
